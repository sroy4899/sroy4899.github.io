...
This plot showcases that our residuals are _roughly_ centered around 0 (given that some residuals are in the 1000s) and although their variability does not differ nearly as much as the previous residuals plot. 
...
<div class="alert alert-info"> 
**Key Point #7: After you have evaluated your model and are sure it is adequate for the problem you are trying to solve, you are ready to make conclusions. ** 
</div>  
